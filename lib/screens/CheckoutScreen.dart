...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  // Handles the complete order placement process and sends data to Laravel backend.
  Future<void> _placeOrder(BuildContext context) async {
    ...
    try {
      // Step 1: Transform cart items into a format suitable for the Laravel API.
      ...
      // Step 2: Convert all the order informations into a single object.
      final orderData = {
        'customer_name': 'N/A',
        'customer_email': 'n/a@example.com',
      ...
      // Step 4: Send the order data to Laravel backend via HTTP POST request.
      // The Laravel OrderController will receive this and save it to MySQL database.
      ...
      // Step 5: Check if the order was successfully saved to the database.
      if (response.statusCode >= 200 && response.statusCode < 300) {
        try {
          final responseData = jsonDecode(response.body);

          // Extract the order ID that was generated by MySQL after saving the order.
          String orderId = 'N/A';
